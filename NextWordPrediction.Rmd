---
title: "Capstone Project Coursera JHU Data Science"
...
```{r Ngrams Dataframes, echo=TRUE, warning=FALSE}
...
```{r Calculate adjusted Counts & Probs, echo=TRUE, message=FALSE, warning=FALSE}
##**Unigram**
...
__Explore the model with example variables__
```{r example.2}
set.seed(16012020)
###example.2
coef1 <-c(0.1,0.3,0.6)
...
**APPENDIX.1**
##Calculating the perplexity model
```{r Perplexity, echo=TRUE, fig.pos="h", message=FALSE, warning=FALSE}
library(knitr)
